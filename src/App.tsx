...
export default function App(){
  return (
   <div className="min-h-screen bg-cream">
      ...
      <Routes>
        {/* Student */}
        <Route path="/" element={<TwoPageShell left={<StudentHome.Left/>} right={<StudentHome.Right/>} />} />
        <Route path="/student/replay" element={<TwoPageShell left={<LectureReplay.Left/>} right={<LectureReplay.Right/>} />} />
        <Route path="/student/quiz" element={<SingleCardShell><Quiz/></SingleCardShell>} />
        <Route path="/student/journal" element={<TwoPageShell left={<Journal.Left/>} right={<Journal.Right/>} />} />

        {/* Teacher */}
        <Route path="/teacher" element={<TwoPageShell left={<TeacherDashboard.Left/>} right={<TeacherDashboard.Right/>} />} />
        <Route path="/teacher/mock-feedback" element={<TwoPageShell left={<MockLectureFeedback.Left/>} right={<MockLectureFeedback.Right/>} />} />
        <Route path="/teacher/feedback-insights" element={<TwoPageShell left={<FeedbackInsights.Left/>} right={<FeedbackInsights.Right/>} />} />

        {/* Parent */}
        <Route path="/parent" element={<ParentDashboard />} />

        <Route path="/parent/weekly-digest" element={<TwoPageShell left={<WeeklyDigest.Left/>} right={<WeeklyDigest.Right/>} />} />
